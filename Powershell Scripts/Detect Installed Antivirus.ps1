...
process {
    ...
    if ($NameCustomField) {
        Write-Host ""
        Write-Host "Note: Custom field '$NameCustomField' was specified but NinjaOne integration has been removed."
        Write-Host "All output has been displayed above."
    }

    if ($StatusCustomField) {
        Write-Host ""
        Write-Host "Note: Custom field '$StatusCustomField' was specified but NinjaOne integration has been removed."
        Write-Host "All output has been displayed above."
    }

    if ($DefinitionDateAndStatusCustomField) {
        Write-Host ""
        Write-Host "Note: Custom field '$DefinitionDateAndStatusCustomField' was specified but NinjaOne integration has been removed."
        Write-Host "All output has been displayed above."
    }
