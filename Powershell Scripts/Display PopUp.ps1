# Displays a popup on the end users screen. The script needs to be run as the Current Logged In User. Use Restart Reminder to display a request to the end user to restart their computer.
<#
.SYNOPSIS
