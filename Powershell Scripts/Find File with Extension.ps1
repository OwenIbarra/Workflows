...
begin {
    ...
    # throw [System.ArgumentOutOfRangeException]::New("Character limit exceeded, value is greater than or equal to 200,000 characters.") # Removed NinjaOne dependency
    # } # Removed NinjaOne dependency
...
process {
    ...
    # Set-NinjaProperty -Name $MultiLineField -Value $CustomFieldValue # Removed NinjaOne dependency
    ...
    if ($WysiwygField -and $MatchingItems) {
        try {
            ...
            # Set the custom field.
    # Set-NinjaProperty -Name $WysiwygField -Value $CustomFieldValue # Removed NinjaOne dependency
