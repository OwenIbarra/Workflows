# This will search under /Applications/* and under each user's Applications folder for the app you speficy to remove and will only remove the first found app.
#!/usr/bin/env bash
