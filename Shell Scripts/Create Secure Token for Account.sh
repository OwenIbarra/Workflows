# Grants secure token access to a Service Account. The account will be created as a service account if it does not exist. Service Accounts will not show up at the desktop login.
#!/usr/bin/env bash
#
